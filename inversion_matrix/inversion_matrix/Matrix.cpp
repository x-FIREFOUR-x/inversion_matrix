 ...
 Matrix Matrix::div_cells()
{
	 if (size_line == size_column)
	 {
		 ...
		 if (A11.size_column > 2)
		 {
			 ...
			 Matrix B11(size_line / 2, size_column / 2);		// 4 матриці на які поділена обернена матриця A
